...
from ..const import CONF_API_CLIENT_ID
from ..const import CONF_API_CLIENT_SECRET
...
class TuyaAPIManager:
    ...
    async def async_get_device_list(self) -> list[dict[str, Any]]:
        ...
        try:
            ...
            raise UpdateFailed("API request timed out") from None
    ...
    async def async_get_device_shadow_properties(
        self, device_id: str, codes: list[str] | None = None
    ) -> dict[str, Any]:
